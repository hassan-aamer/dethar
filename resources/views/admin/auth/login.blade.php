...
<head>
    ...
    <!-- App favicon -->
    <link rel="icon" href="{{ App\Helpers\Image::getMediaUrl(App\Models\Setting::first(), 'logo') }}?v={{ time() }}" type="image/png" />
    ...
    <!-- icons -->
    <link href="{{ App\Helpers\Image::getMediaUrl(App\Models\Setting::first(), 'logo') }}" rel="stylesheet" type="text/css" />
