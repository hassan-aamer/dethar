                    ...
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <a class="btn btn-success"
                                href="{{ route('admin.technical_data_sheets.create') }}">{{ __('attributes.create') }}</a>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-1">{{ __('attributes.technical_data_sheets') }}</h4>
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <form id="deleteForm{{ $categories->id }}"
                                                                action="{{ route('admin.technical_data_sheets.delete', $categories->id) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('delete')
    ...
    <script>
        document.querySelectorAll('input[type="checkbox"]').forEach(checkbox => {
            checkbox.addEventListener('change', function() {
                ...
                fetch("{{ route('admin.technical_data_sheets.status', app()->getLocale()) }}", {
                    method: 'POST',
                    headers: {
