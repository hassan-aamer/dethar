                    ...
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <a class="btn btn-success"
                                href="{{ route('admin.blogs_category.create') }}">{{ __('attributes.create') }}</a>
                                            ...
                                            @foreach ($result as $categories)
                                                <tr id="row-{{ $categories->id ?? '' }}">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('admin.blogs_category.edit', $categories->id) }}">
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <form id="deleteForm{{ $categories->id }}"
                                                                action="{{ route('admin.blogs_category.delete', $categories->id) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('delete')
    ...
    <script>
        document.querySelectorAll('input[type="checkbox"]').forEach(checkbox => {
            checkbox.addEventListener('change', function() {
                ...
                fetch("{{ route('admin.blogs_category.status', app()->getLocale()) }}", {
                    method: 'POST',
                    headers: {
