...
@section('content')
    <main class="main">
        ...
        <section id="hero" class="hero section dark-background">
            <img src="{{ page_image('our products') }}" alt="" class="hero-bg d-none d-md-block" data-aos="fade-in"
                loading="lazy">
            <img src="{{ page_image('our products') }}" alt="" class="hero-bg d-block d-md-none" data-aos="fade-in"
                loading="lazy">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <p>{{ page('our products', 'description') }}</p>
                        <nav class="breadcrumbs">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    {{ page('our products', 'title') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
