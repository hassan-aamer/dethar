...
@section('content')
    <main class="main">
        ...
        <section id="hero" class="hero section dark-background">
            <img src="{{ page_image('what we do details') }}" alt=""
                    ...
                    <div class="col-12 text-center">
                        ...
                        <nav class="breadcrumbs">
                            <ol class="breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ page('what we do details', 'title') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <!-- Details Section -->
        <section id="what-we-do-details" class="about section">
            <div class="container">
                <div class="row gy-4 align-items-start">
                        ...
                        <div class="services-list">
                            @foreach ($result['what_we_dos'] as $what_we_do)
                                <a class="{{ request()->routeIs('what.details') && request()->route('id') == $what_we_do->id ? 'active' : '' }}"
                                    href="{{ route('what.details', $what_we_do->id) }}">
                                    {{ $what_we_do->title ?? '' }}
                                </a>
                            @endforeach
                        </div>
                    ...
                    <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
                        <div class="img-scale-animation mb-4">
                            <img src="{{ App\Helpers\Image::getMediaUrl($result['what_we_do'], 'what_we_do') }}"
                                alt="{{ $result['what_we_do']->title ?? '' }}" class="img-fluid" loading="lazy">
                        </div>
