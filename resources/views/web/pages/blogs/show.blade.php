...
@section('content')
    <main class="main">
        ...
        <section id="hero" class="hero section dark-background">
            <img src="{{ page_image('blog details') }}" alt="" class="hero-bg d-none d-md-block" data-aos="fade-in"
                loading="lazy">
            <img src="{{ page_image('blog details') }}" alt="" class="hero-bg d-block d-md-none" data-aos="fade-in"
                loading="lazy">
                    ...
                    <div class="col-12 text-center">
                        ...
                        <nav class="breadcrumbs">
                            <ol class="breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ page('blog details', 'title') }}
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="row gy-4 align-items-start">
                    ...
                    <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
                        <div class="img-scale-animation mb-4">
                            <img src="{{ App\Helpers\Image::getMediaUrl($result['blog'], 'blogs') }}"
