...
@section('content')
    <main class="main">
        ...
        <section id="hero" class="hero section dark-background">
            <img src="{{ page_image('blogs') }}" alt="" class="hero-bg d-none d-md-block" data-aos="fade-in"
                loading="lazy">
            <img src="{{ page_image('blogs') }}" alt="" class="hero-bg d-block d-md-none" data-aos="fade-in"
                loading="lazy">
                        ...
                        @foreach ($result as $item)
                            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                                <div class="card">
                                    ...
                                    <h3><a href="{{ route('blog.details', $item->id) }}"
