...
@section('content')
    <main class="main">
        ...
        <section id="hero" class="hero section dark-background">
            <img src="{{ page_image('value add details') }}" alt=""
                    ...
                    <div class="col-12 text-center">
                        ...
                        <nav class="breadcrumbs">
                            <ol class="breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ page('value add details', 'title') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <!-- Value Add Details Section -->
        <section id="value-details" class="about section">
            <div class="container">
                <div class="row gy-4 align-items-start">
                        ...
                        <div class="services-list">
                            @foreach ($result['value_adds'] as $value_add)
                                <a class="{{ request()->routeIs('value.details') && request()->route('id') == $value_add->id ? 'active' : '' }}"
                                    href="{{ route('value.details', $value_add->id) }}">
                                    {{ $value_add->title ?? '' }}
                                </a>
                            @endforeach
                        </div>
                    ...
                    <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
                        <div class="img-scale-animation mb-4">
                            <img src="{{ App\Helpers\Image::getMediaUrl($result['value_add'], 'value_add') }}"
                                alt="{{ $result['value_add']->title ?? '' }}" class="img-fluid" loading="lazy">
                        </div>
