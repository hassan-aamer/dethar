...
@section('content')
    <main class="main">
        ...
        <section id="hero" class="hero section dark-background">
            <img src="{{ page_image('value add') }}" alt="" class="hero-bg d-none d-md-block" data-aos="fade-in"
                loading="lazy">
            <img src="{{ page_image('value add') }}" alt="" class="hero-bg d-block d-md-none" data-aos="fade-in"
                loading="lazy">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <p>{{ page('value add', 'description') }}</p>
                        <nav class="breadcrumbs">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    {{ page('value add', 'title') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        @foreach ($result as $item)
                            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                                <div class="card">
                                    ...
                                    <h3><a href="{{ route('value.details', $item->id) }}"
